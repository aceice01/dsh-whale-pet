# defringe.py — remove magenta/green chroma-key residue from the pet frames.
# Pure magenta (255,0,255) and near-magenta pixels are chroma-key spill, not
# part of the character (blue/white/pink palette). Turn them transparent.
import os
